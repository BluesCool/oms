<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="currencyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="货币序号" align="center" prop="currencyId" />
      <el-table-column label="货币名称" align="center" prop="currencyName" />
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除货币编号为"' + currencyIds + '"的数据项？').then(function() {
