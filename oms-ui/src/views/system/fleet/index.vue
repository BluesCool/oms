<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="责任人" prop="responsibleMan">
        <el-input
          v-model="queryParams.responsibleMan"
          placeholder="请输入责任人"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="责任人电话" prop="responsibleManPhone">
        <el-input
          v-model="queryParams.responsibleManPhone"
    ...
    <el-table v-loading="loading" :data="fleetList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="车队序号" align="center" prop="fleetId" />
      <el-table-column label="车队名称" align="center" prop="fleetName" />
      <el-table-column label="责任人" align="center" prop="responsibleMan" />
      <el-table-column label="责任人电话" align="center" prop="responsibleManPhone" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="责任人" prop="responsibleMan">
          <el-input v-model="form.responsibleMan" placeholder="请输入责任人" />
        </el-form-item>
        <el-form-item label="责任人电话" prop="responsibleManPhone">
          <el-input v-model="form.responsibleManPhone" placeholder="请输入责任人电话" />
        </el-form-item>
        <el-form-item label="车牌号码" prop="licensePlateNumber">
          <el-input v-model="form.licensePlateNumber" placeholder="请输入车牌号码" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除车队编号为"' + fleetIds + '"的数据项？').then(function() {
