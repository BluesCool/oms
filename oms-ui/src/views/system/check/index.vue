<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="查验名称" prop="checkName">
        <el-input
    ...
    <el-table v-loading="loading" :data="checkList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="查验序号" align="center" prop="checkId" />
      <el-table-column label="查验名称" align="center" prop="checkName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="查验名称" prop="checkName">
          <el-input v-model="form.checkName" placeholder="请输入查验名称" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除查验编号为"' + checkIds + '"的数据项？').then(function() {
